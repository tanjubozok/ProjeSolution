...
namespace Proje.Business.ValidationRules
{
    public class ContactValidator : AbstractValidator<Contact>
    {
        public ContactValidator()
        {
            ...
            RuleFor(x => x.Email).MaximumLength(200).WithMessage("Lütfen en fazla 50 karakter girişi yapınız.");
            ...
            RuleFor(x => x.Message).MinimumLength(3).WithMessage("Lütfen en az 10 karakter girişi yapınız.");
            RuleFor(x => x.Message).MaximumLength(200).WithMessage("Lütfen en fazla 1000 karakter girişi yapınız.");
        }
    }
}
